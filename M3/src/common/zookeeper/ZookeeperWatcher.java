    ...
    private void getNewData() throws KeeperException, InterruptedException {
        ...
        switch(newMessage.zNodeMessageStatus){
            ...
            case NEW_ZNODE_RECEIVE_DATA:
                ...
                ss = new ServerStatus(newMessage.zNodeMessageStatus,newMessage.getMoveDataRange(),newMessage.getTargetName(), newMessage.getRemoveLocal(), newMessage.getRangeUpdate());
