...
public class AdditionalTest extends TestCase {
	...
	public void testFIFO(){
		 ...
		 */
		StorageManager sm = new StorageManager(5,"FIFO", TEST_DB_PATH);
		sm.clearAll();
	...
	public void testLRU(){
		 ...
		 * ensures correct keys are in cache
		 */
		StorageManager sm = new StorageManager(5,"LRU", TEST_DB_PATH);
		sm.clearAll();
	...
	public void testLFU(){
		 ...
		 * ensures correct keys are in cache
		 */
		StorageManager sm = new StorageManager(5,"LFU", TEST_DB_PATH);
		sm.clearAll();
	...
	public void testInsertionPolicy(){
		 ...
		 */
		final StorageManager sm = new StorageManager(5,"LRU", TEST_DB_PATH);
		sm.clearAll();
